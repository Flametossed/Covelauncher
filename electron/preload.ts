...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // Firmware management
  addFirmwareSource:          (firmware: any) => ipcRenderer.invoke('add-firmware-source', firmware),
  removeFirmwareSource:       (id: string)    => ipcRenderer.invoke('remove-firmware-source', id),
